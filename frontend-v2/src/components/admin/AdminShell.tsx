        ...
        <header className="sticky top-0 z-40 border-b border-line bg-surface/90 backdrop-blur-xl">
          <div className="flex h-14 items-center gap-2 px-3 md:px-4">
            <button
              ...
              className="rounded-md p-2 text-muted transition hover:bg-surface2 hover:text-point-ink md:hidden"
            >
              <Menu className="h-5 w-5" />
            </button>

            <Link href="/admin" className="flex items-center gap-2">
              <span className="flex h-7 w-7 items-center justify-center rounded-md bg-point-soft text-point-ink">
                <Shield className="h-4 w-4" />
              </span>
              <span className="font-display text-sm font-bold tracking-tight">
                AUTOHEART <span className="text-point-ink">ADMIN</span>
              </span>
            </Link>
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md border border-line px-2.5 py-1.5 text-xs text-dim transition hover:border-point/40 hover:text-muted"
            >
            ...
            <button
              ...
              className="rounded-md p-2 text-dim transition hover:bg-surface2 hover:text-point-ink"
            >
            ...
            <Link
              href="/queue"
              className="hidden items-center gap-1.5 rounded-md border border-line px-2.5 py-1.5 text-xs text-muted transition hover:border-point/40 hover:text-point-ink sm:flex"
            >
            ...
            <button
              ...
              className="rounded-md p-2 text-dim transition hover:bg-fail-soft hover:text-fail-ink"
            >
        ...
        <div className="mx-auto flex w-full max-w-[1600px]">
          ...
          >
            ...
            <button
              ...
              className="mt-3 flex items-center gap-2 rounded-md px-3 py-2 text-xs text-dim transition hover:bg-surface2 hover:text-point-ink"
            >
              {collapsed ? (
        ...
        {drawer && (
          <div className="fixed inset-0 z-50 md:hidden">
            <div
              ...
              aria-hidden
            />
            <div className="absolute inset-y-0 left-0 flex w-[82%] max-w-xs flex-col overflow-y-auto border-r border-line bg-surface p-3">
              ...
              <Link
                href="/queue"
                className="mt-3 flex items-center gap-2 rounded-md px-3 py-2 text-sm text-dim transition hover:text-point-ink"
              >
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active
          ? "bg-point-soft font-medium text-point-ink shadow-[inset_2px_0_0_currentColor]"
        ...
        (collapsed ? (
          ...
          <span
            className={cn(
              ...
              alerting ? "bg-fail-soft text-fail-ink" : "bg-live-soft text-live-ink"
            )}
          >
            {count > 99 ? "99+" : count}
          </span>
              ...
              <li key={item.href}>
                <button
                  ...
                  className={cn(
                    ...
                    i === cursor ? "bg-point-soft text-point-ink" : "text-muted"
                  )}
                >
                  <Icon className="h-4 w-4 shrink-0" />
