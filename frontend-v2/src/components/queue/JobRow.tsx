...
import { cn, formatHearts, formatPoints, formatWait } from "@/lib/utils";
  ...
  return (
    <div
      ...
      className={cn(
        ...
        running && "bg-live-soft/60 shadow-[inset_2px_0_0_var(--live)]"
      )}
    >
      <div className="pt-0.5 font-mono text-xs tabular-nums text-dim">
        {running ? (
          <Play className="h-3.5 w-3.5 fill-live text-live" aria-label="กำลังรัน" />
