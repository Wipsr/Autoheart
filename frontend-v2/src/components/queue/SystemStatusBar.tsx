...
export function SystemStatusBar({
  ...
  return (
    <div
      className={cn(
        "flex flex-wrap items-center gap-x-7 gap-y-4 rounded-card border border-line bg-surface px-4 py-3 shadow-card",
        className
      )}
    >
      ...
      {yourPosition != null && (
        <Stat label="คิวของคุณ" value={`#${yourPosition}`} tone="text-wait-ink" />
      )}
