...
/** ตั้ง slug อัตโนมัติจากจำนวนพอยท์ ให้ล้อรูปแบบเดิม (1000-hearts)
 *  slug เป็นคีย์ถาวรที่ migration/seed อ้างถึง เลยคง suffix -hearts ไว้ ไม่เปลี่ยนตามคำที่แสดง */
    ...
    <div className="space-y-4">
      ...
      <Card className="overflow-hidden">
        ...
        {!loading &&
          rows.map((p) =>
            editingId === p.id ? (
              <div key={p.id} className="border-b border-lineSoft bg-subtle p-4 last:border-b-0">
              ...
              >
                ...
                <div className="flex items-center gap-4 font-mono text-xs tabular-nums text-muted">
                  <span>
                    {p.points.toLocaleString()} พอยท์ · {p.price_baht.toLocaleString()} ฿
                  </span>
