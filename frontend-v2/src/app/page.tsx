...
import { KeyRound, Lock, ShieldCheck, Waves } from "lucide-react";
...
const SECURITY = [
  ...
  },
  {
    ...
    desc: "ระบบลองล็อกอิน DevPlay ให้ก่อนโดยไม่คิดเงิน ไอดีที่ไม่ผ่านจะไม่เข้าคิวและไม่เสียพอยท์",
  },
  {
    icon: KeyRound,
...
const HOW_TO_PAY = [
  ...
  "พอยท์เข้าอัตโนมัติและงานเข้าคิวทันที ดูความคืบหน้าได้ที่หน้าคิว",
];
          ...
          <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-muted">
                ชำระด้วยซองอั่งเปา TrueMoney · เทียบราคาต่อ 100 พอยท์ได้ในทุกแพ็ค
              </p>
            </div>
            <p className="font-mono text-[11px] uppercase tracking-widest text-dim">
              หักพอยท์เมื่อสั่งงานเท่านั้น
            </p>
          </div>
