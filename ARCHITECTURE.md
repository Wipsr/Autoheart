...
│   │   │   │   ├── friend-requests/page.tsx  # รับคำขอเป็นเพื่อน (ฟรี ไม่ผ่านคิว)
...
│   │   │   ├── friends.py             # POST /api/friends/list|accept|delete (ฟรี)
...
│       ├── friend_tool.py              # list/accept/remove friends (เมนูรับ+ลบเพื่อนบนเว็บ)
