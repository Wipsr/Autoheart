...
from api.routes import account, admin, auth, credentials, friends, jobs, packages, public, queue, saved_accounts, tools, topup, websocket
...
def create_app() -> FastAPI:
    ...
    app.include_router(tools.ws_router)
