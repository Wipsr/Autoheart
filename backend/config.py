...
class Settings(BaseSettings):
    ...
    # cookie ของ session ngmx ที่ใช้เป็น "บัญชีบริการ" ของเรา (ฟีเจอร์ปั๊มผง)
    # ว่างไว้ = ขอ guest session ใหม่ทุกครั้งที่บูต ซึ่งได้บัญชีพ้อยท์ 0 ทุกรอบ
    # ตั้งค่านี้เมื่อแอดมิน ngmx ให้พ้อยท์/สิทธิ์ใช้ฟรีกับบัญชีใดบัญชีหนึ่งไว้แล้ว
    ngmx_session_cookie: str = ""
